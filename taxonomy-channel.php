		...
		<div class="row category-header">
		    <div class="large-5 columns">
		    	...
		    	<div class="subscribe-area">
		    		...
		    		<a href="/channels">Channels</a> > <span><?php single_cat_title('',true); ?></span>
		    		</div>
				<?php
				$thecat = get_queried_object()->term_id;
				echo do_shortcode('[wpw_follow_term_me posttype="post" taxonomy="channel" termid="'.$thecat.'" followtext="Subscribe" followerscountmsg="{followers_count} Subscribers" followingtext="Subscribed" unfollowtext="Unsubscribe"][/wpw_follow_term_me]'); 
				?>
				</div>
				</div>
		    </div>
...
<?php $this_channel = get_queried_object()->slug;?>
	<h2 class="content-heading"><a href="<?php echo home_url( '/' ) . 'channel/' .$this_channel; ?>/feed/" class="RSS-button" data-icon="&#xe00b;"></a>
